...
contract DeployMockSeries is Script {
    ...
    function _deploy(string memory ticker, uint256 maturity) internal returns (Deployed memory d) {
        ...
        d.poolPT = new MockV3Pool(address(d.vault.pt()), address(d.stock), PriceMath.sqrtPriceX96(address(d.vault.pt()), address(d.stock), 0.96e18, 18, 18));
        d.poolYT = new MockV3Pool(address(d.vault.yt()), address(d.stock), PriceMath.sqrtPriceX96(address(d.vault.yt()), address(d.stock), 0.04e18, 18, 18));

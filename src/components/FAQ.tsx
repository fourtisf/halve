  ...
  return (
    <section id="faq" style={{ paddingTop: 0 }}><div className="wrap">
      ...
      <div className="faq">
        ...
        <details><summary>Can I set my own price instead of buying now?</summary><p>Yes. On the Trade tab choose Limit, type a price and place the order. Halve puts your money into the Uniswap v3 pool as a one-tick position just below the market for a buy, or above it for a sell. When the price crosses it, the pool converts it at your price or better and you earn the pool fee instead of paying it. Press Claim once it fills. Nothing is locked: cancel any time and the deposit comes straight back.</p></details>

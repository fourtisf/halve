  ...
  return (
    <div className="ways">
      <div className="way">
        ...
        <div className="act"><Link className="btn btn-white btn-sm" href={`/app?s=${index}&tab=buy&side=pt`}>Buy PT</Link><Link className="btn btn-line btn-sm" href="/lend">Use as collateral</Link></div>
      </div>
      <div className="way yt">
        ...
        <div className="act"><Link className="btn btn-white btn-sm" href={`/app?s=${index}&tab=buy&side=yt`}>Buy YT</Link></div>
      </div>
    </div>
  )
}
